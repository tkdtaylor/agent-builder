...
| 005 | dep-scan blocking gate step | 005-gate-dep-scan-test-spec.md | ✅ | 🟡 | `go test ./internal/gate/... -run TestDepScan -count=1` -> `ok github.com/tkdtaylor/agent-builder/internal/gate` |
