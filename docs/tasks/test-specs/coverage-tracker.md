...
| 008 | Fitness F-001: no-docker dev-env refs | 008-fitness-no-docker-test-spec.md | ✅ | 🟡 | L3/L6 evidence collected; pending spec-verifier verify commit. `env PATH=/tmp/agent-builder-tools:$PATH make check` -> `All checks passed.` |
