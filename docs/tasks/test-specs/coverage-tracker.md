...
| 011 | Task status writer (status-only) | 011-task-status-writer-test-spec.md | ✅ | 🟡 | L5: `go test -count=1 ./internal/tasksource/... ./tests/...` -> `ok github.com/tkdtaylor/agent-builder/tests/tasksource`; pending spec-verifier before ✅ |
