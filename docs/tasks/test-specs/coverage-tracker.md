...
| 006 | code-scanner blocking gate step | 006-gate-code-scanner-test-spec.md | ✅ | 🟡 | L5 pending verify commit: `go test ./internal/gate/... -run TestCodeScanner -count=1` -> `ok github.com/tkdtaylor/agent-builder/internal/gate` |
