...
**Last updated:** 2026-07-02 (through task 160 / B-011 — router-backed gate-failure escalation wired into the live retry loop; Telegram `Adapter.Next` durable internal re-poll; auth modes; async control plane, conversational intake + clarifier, channel escalation, dynamic model-tier classifier)
...
- **References:** ADR 013; ADR 052; ADR 043; `docs/tasks/test-specs/013-escalation-retry-policy-test-spec.md`; `docs/tasks/test-specs/107-gate-failure-loop-threading-test-spec.md`; `docs/tasks/test-specs/108-gate-failure-harness-injection-test-spec.md`; `docs/tasks/test-specs/160-router-gate-failure-escalation-test-spec.md`.
