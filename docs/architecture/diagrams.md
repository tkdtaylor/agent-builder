...
**Last updated:** 2026-07-01 (task 151 — Telegram inbound gains an opt-in sender-ID auth-mode branch ahead of the envelope pipeline: `envelope` default / `disabled` / `allowlist` plaintext accept via the `internal/channel/telegram/authz` store, ADR 063)
